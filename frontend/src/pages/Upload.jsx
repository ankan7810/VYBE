...
function Upload() {
  ...
  return (
    <div className='w-full h-[100vh] bg-black flex flex-col items-center '>
      ...
      {frontendMedia && (
        <div className='w-[80%] max-w-[500px] h-auto flex flex-col items-center justify-center mt-[15vh]'>
          {mediaType === "image" && (
            <div className='w-[80%] max-w-[500px] h-[250px] flex flex-col items-center justify-center mt-[5vh] '>
              ...
              {uploadType !== "story" && (
                <div className="relative w-full mt-[20px]">
                  ...
                  {showEmojiPicker && (
                    <div className="absolute -top-[350px] left-0 z-50">
                      <EmojiPicker onEmojiClick={onEmojiClick} theme="dark" />
                    </div>
                  )}

                  <div className="flex items-center gap-2">
                    <button type="button" className="text-white text-2xl" onClick={() => setShowEmojiPicker(!showEmojiPicker)}>
                      <BsEmojiSmile />
                    </button>
                    <input
                      type='text'
